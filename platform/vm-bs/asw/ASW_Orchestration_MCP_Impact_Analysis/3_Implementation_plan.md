...
# Based on {impact_analysis}, workspace and {memory_context} create a failproof, clear, and concise implementation plan
...
-> A brief summary of modifications to be done without code snippets.
...
Also make sure function signature mismatch is not present: 
